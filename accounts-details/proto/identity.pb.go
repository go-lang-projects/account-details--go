...
func (x *Identity) GetName() string {
	if x, ok := x.GetIdentity().(*Identity_Name); ok {
		return x.Name
	}
	return ""
}
...
func (x *Identity) GetId() uint32 {
	if x, ok := x.GetIdentity().(*Identity_Id); ok {
		return x.Id
	}
	return 0
}
...
func (*Identity_Name) isIdentity_Identity() {}

func (*Identity_Id) isIdentity_Identity() {}
...
var file_identity_proto_rawDesc = []byte{
	...
	0x12, 0x0d, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x6f, 0x6e, 0x65, 0x6f, 0x66, 0x22,
	0x3e, 0x0a, 0x08, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x14, 0x0a, 0x04, 0x6e,
	0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x04, 0x6e, 0x61, 0x6d,
	0x65, 0x12, 0x10, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x48, 0x00, 0x52,
	0x02, 0x69, 0x64, 0x42, 0x0a, 0x0a, 0x08, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x42,
	0x0e, 0x5a, 0x0c, 0x65, 0x61, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62,
...
var file_identity_proto_goTypes = []interface{}{
	(*Identity)(nil), // 0: example.oneof.Identity
}
